...
- [ ] Dual monitor setup
    - [ ] Required for [AWESOME](./../arch/.config/awesome/system/displays.lua)
...
- [ ] Bluetooth setup
    - [ ] Required for [AWESOME](./../arch/.config/awesome/system/bluetooth.lua)
...
- [ ] Brightness
    - [ ] Required for [AWESOME](./../arch/.config/awesome/system/brightness.lua)
- [ ] Steam
    - [ ] Proton is enabled
