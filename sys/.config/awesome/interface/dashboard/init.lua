...
dashboard_layout:add_widget_at(progressbar_area, 5, 12, 2, 5)
dashboard_layout:add_widget_at(sliders_area, 6, 6, 2, 5)

dashboard_layout:add_widget_at(volume_area, 5, 8, 1, 1)
dashboard_layout:add_widget_at(bluetooth_area, 7, 13, 1, 1)
